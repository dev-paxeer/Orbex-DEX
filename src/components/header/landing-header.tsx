...
const LandingHeader = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="relative flex items-center justify-between rounded-[27px] lg:rounded-full border border-black/15 bg-black/70 backdrop-blur-sm px-3 sm:px-4 md:px-6 py-2 shadow-[0_4px_30px_rgba(0,0,0,0.3)] overflow-hidden">
          {/* Background elements */}
          <motion.div 
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            <Link href="/" className="flex items-center group">
              <div className="relative">
                ...
                <img src="/logo/PrimeLogo.png" alt="PrimeSwap Logo" className="h-8 w-8 sm:h-10 sm:w-10 md:h-12 md:w-12 lg:h-14 lg:w-14 relative z-10" />
              </div>
              <div className="ml-2 sm:ml-3 md:ml-4 flex flex-col">
                <span className="text-white text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold tracking-wide">Orbex</span>
              </div>
            </Link>
          </motion.div>
            ...
            {links.map((link) => (
              <Link
                ...
                className={`relative ${
                  link.label === "Launch App" 
                    ? "group inline-flex items-center gap-2 px-4 sm:px-5 md:px-6 lg:px-8 py-2 md:py-3 bg-gradient-[#0064A7] to-[#0064A7] hover:from-[#0064A7] hover:to-[#0064A7] text-white text-sm sm:text-base md:text-lg font-medium rounded-[27px] lg:rounded-full border border-gray-300/40 relative overflow-hidden"
              ...
              >
                ...
                {link.label === "Launch App" && (
                  <>
                    <motion.div
                      className="absolute inset-0 bg-gradient-[#0064A7] to-[#0064A7] from-transparent via-white/10 to-transparent"
                      animate={{
                        x: ["-100%", "100%"],
                      }}
                      transition={{
                ...
                {link.label !== "Launch App" && (
                  <span
                    className={`absolute -bottom-1 left-0 h-0.5 bg-gradient-[#0064A7] to-[#0064A7] from-transparent via-white/10 to-transparent transition-all duration-300 ${
          ...
          >
            <button 
              ...
              className="px-3 py-1.5 rounded-full border border-[#0064A7]/20 bg-[#0064A7]/10 text-sm text-[#0064A7] font-medium flex items-center gap-1.5"
            >
