    ...
    >
      {integrations.map((integration, index) => (
        <div
          ...
          className="bg-[#0a0a0a] border border-[#b979f0]/30 rounded-lg p-6 shadow-lg shadow-[#b979f0]/10 hover:border-[#b979f0]/50 transition-all duration-300 relative overflow-hidden group"
        >
      ...
      <div className="max-w-screen-xl mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-bold text-center mb-2">
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#b979f0] to-[#4c30ad]">Seamless</span> Ecosystem
          </h2>
        ...
        <div className="grid lg:grid-cols-2 items-center lg:gap-16">
          <div>
            <h3 className="text-2xl md:text-3xl font-bold mb-6">
              Play well with <span className="text-[#b979f0]">others</span>
            </h3>
            ...
            <ul className="space-y-4">
              {integrations.slice(0, 3).map((integration, index) => (
                <li key={index} className="flex items-start">
                  <div className="w-6 h-6 rounded-full bg-[#b979f0]/30 border border-[#b979f0]/30 flex items-center justify-center mr-3 mt-1">
                    <span className="text-xs text-[#b979f0]">✓</span>
                  </div>
                  <div>
