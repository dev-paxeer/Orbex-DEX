...
export function TechnologySection() {
    ...
    return (
        <section className="py-24 relative z-10 overflow-hidden">
            ...
            <div className="absolute top-0 right-1/4 w-96 h-96 bg-[#b979f0]/5 rounded-full blur-[120px]" />
            <div className="absolute bottom-0 left-1/4 w-96 h-96 bg-[#b979f0]/5 rounded-full blur-[120px]" />
            ...
            <div className="max-w-screen-xl mx-auto px-4">
                ...
                <div className="relative">
                    ...
                    ${activeFeature === index
                                            ? "border-[#b979f0]/50 shadow-lg shadow-[#b979f0]/20"
                                            : "border-[#b979f0]/30 hover:border-[#b979f0]/40"
                                        }
                  `}
                                >
                                    {/* Card background with gradient */}
                                    <div className="absolute inset-0 bg-gradient-to-br from-[#b979f0]/20 via-transparent to-[#b979f0]/20 opacity-50" />
                          ...
                          ${activeFeature === index
                                                        ? "bg-[#b979f0]/30 border-[#b979f0]/50"
                                                        : "bg-[#b979f0]/30 border-[#b979f0]/30"
                                                    }
                          border
                        `}
                                            >
                                                <feature.icon className={`h-6 w-6 ${activeFeature === index ? "text-[#b979f0]" : "text-white"}`} />
                                            </div>
                          ...
                          ${activeFeature === index ? "text-[#b979f0]" : "text-white hover:text-[#b979f0]"}
                        `}
                                            >
                                            ...
                                            {activeFeature === index && (
                                                <motion.div
                                                    ...
                                                    className="mt-6 pt-6 border-t border-[#0a0a0a]/30"
                                                >
                                                    ...
                                                    {feature.stats && feature.stats.length > 0 && (
                                                        <div className="flex flex-wrap gap-2 mt-4">
                                                            {feature.stats.map((stat, i) => (
                                                                <span key={i} className="px-3 py-1 bg-[#0a0a0a]/30 text-white rounded-full text-xs font-medium">
                                                                    {stat}
                                                                </span>
                                                            ))}
                                                        </div>
