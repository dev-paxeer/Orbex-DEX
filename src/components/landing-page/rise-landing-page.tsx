    ...
    <main className="text-white min-h-screen overflow-hidden bg-black">
        ...
        <div className="max-w-screen-xl mx-auto px-4 relative z-10">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-1">
              <div className="inline-block px-4 py-2 bg-gradient-to-r from-[#b979f0] to-[#4c30ad] text-white font-semibold rounded-full z-60 relative overflow-hidden mb-5">
                Decentralized Exchange on Paxeer Network
              </div>
              <BlurText
                text="Trade the modern way"
                delay={150}
                animateBy="words"
                direction="top"
              ...
              />
              <BlurText
                text="Trade the Orbex way"
                delay={150}
                animateBy="words"
                direction="top"
                className="text-5xl md:text-6xl font-bold text-[#b979f0]"
              />
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                <Link href="/markets" target="_blank">
                  <Button className="bg-gradient-to-r from-[#b979f0] to-[#4c30ad] text-white hover:bg-gradient-to-r hover:from-[#4c30ad] hover:to-[#b979f0] px-6 py-6 text-lg font-medium rounded-xl border border-gray-300/40 relative overflow-hidden group">
            ...
            <div className="relative">
              ...
              <div className="relative rounded-2xl bg-[#0a0a0a] border border-[#b979f0]/30 overflow-hidden shadow-2xl shadow-[#b979f0]/20">
                {/* Glowing border effect */}
                <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-[#b979f0]/20 via-[#4c30ad]/10 to-[#b979f0]/20 opacity-50" />

                {/* Header with tabs */}
                <div className="bg-[#111111] px-6 py-4 border-b border-[#b979f0]/30 flex items-center justify-between">
                  <div className="flex items-center space-x-2">
                    <div className="w-3 h-3 rounded-full bg-[#b979f0]" />
                    <span className="font-bold text-white">WPAX/USD</span>
                    <span className="text-green-400">$2.24</span>
                    <span className="text-green-400 text-sm">+17.4%</span>
                  </div>
                  <div className="flex text-sm">
                    <div className="px-3 py-1 bg-[#b979f0]/30 text-white rounded-l-md border border-[#b979f0]/30">1H</div>
                    <div className="px-3 py-1 bg-[#0a0a0a] text-gray-300 rounded-r-md border border-[#b979f0]/30">1D</div>
                  </div>
                </div>
                ...
                <div className="px-6 py-8 bg-[#0a0a0a]">
                  <div className="h-60 w-full relative">
                    ...
                    {[...Array(5)].map((_, i) => (
                      <div
                        key={i}
                        className="absolute w-full h-px bg-[#b979f0]/30"
                        style={{ top: `${i * 25}%` }}
                      >
                    ...
                    <svg className="absolute inset-0 w-full h-full" preserveAspectRatio="none">
                      ...
                      <defs>
                        <linearGradient id="gradient" x1="0%" y1="0%" x2="0%" y2="100%">
                          <stop offset="0%" stopColor="#b979f0" />
                          <stop offset="100%" stopColor="#b979f0" stopOpacity="0" />
                        </linearGradient>
                      </defs>
                    </svg>

                    {/* Price indicator dot */}
                    <div className="absolute top-[30px] right-[40px] w-4 h-4 rounded-full bg-[#b979f0] border-2 border-[#0a0a0a] shadow-lg shadow-[#b979f0]/50" />
                  </div>
                </div>

                {/* Trading controls */}
                <div className="px-6 pb-6 grid grid-cols-2 gap-4 bg-[#0a0a0a]">
                  <button className="py-3 px-5 bg-[#b979f0]/80 text-white font-bold rounded-lg hover:bg-[#b979f0]/80 transition-colors relative overflow-hidden group border border-[#b979f0]/30">
              ...
              {/* Stats floating card */}
              <div className="absolute -right-4 -bottom-16 p-4 bg-[#0a0a0a] border border-[#b979f0]/30 rounded-xl shadow-md shadow-[#b979f0]/20 w-60">
                {/* Glowing border effect */}
                <div className="absolute inset-0 rounded-xl bg-gradient-to-r from-[#b979f0]/20 via-[#4c30ad]/10 to-[#b979f0]/20 opacity-50" />
                ...
                <div className="flex justify-between items-center mb-3 relative z-15">
                  ...
                  <ArrowRightCircle size={16} className="text-[#b979f0]" />
                </div>
                <div className="space-y-2 relative z-10">
                  <div className="flex justify-between">
                    <span className="text-xs text-gray-400">24h Volume</span>
                    <span className="text-xs font-medium text-[#b979f0]">$1.2B</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-xs text-gray-400">Open Interest</span>
                    <span className="text-xs font-medium text-[#b979f0]">$840M</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-xs text-gray-400">Funding Rate</span>
                    <span className="text-xs font-medium text-[#b979f0]">+0.01%</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-screen-xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-2">
              Common <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#b979f0] to-[#4c30ad]">Issues</span> in Trading
            </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {problems.map((problem, index) => (
              <div
                key={index}
                className="bg-[#0a0a0a] border border-[#b979f0]/30 rounded-lg p-6 shadow-lg shadow-[#b979f0]/10 relative overflow-hidden group hover:border-[#b979f0]/50 transition-all duration-300"
              >
                <div className="absolute inset-0 rounded-lg bg-gradient-to-r from-[#b979f0]/20 via-[#4c30ad]/10 to-[#b979f0]/20 opacity-50" />
      ...
      <section className="py-20 relative z-10">
        <div className="max-w-screen-xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-2">
              Why Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#b979f0] to-[#4c30ad]">Platform</span> is Different
            </h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-8 relative">
            {features.map((feature, index) => (
              <div key={index} className="relative">
                <Card className="bg-[#0a0a0a] border border-[#b979f0]/30 h-full transition-all duration-300">
                  <CardContent className="p-6 flex flex-col h-full">
                    <div className="flex justify-between items-start mb-4">
                      <div className="w-12 h-12 rounded-full bg-[#b979f0]/30 border border-[#b979f0]/30 flex items-center justify-center relative z-10">
                        <feature.icon className="h-6 w-6 text-[#b979f0]" />
                      </div>
                    </div>
      ...
      <section className="py-20 relative z-10">
        <div className="max-w-screen-xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-2">
              Start Trading in <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#b979f0] to-[#4c30ad]">Three Steps</span>
            </h2>
                  ...
                  <Card className="bg-[#0a0a0a] border border-[#b979f0]/30 h-full transition-all duration-300">
                    <CardContent className="p-6 flex flex-col h-full">
                      <div className={`flex ${index % 2 === 0 ? 'justify-between' : 'flex-row-reverse justify-between'} items-start mb-4`}>
                        <div className="w-12 h-12 rounded-full bg-[#b979f0]/30 border border-[#b979f0]/30 flex items-center justify-center relative z-10">
                          <step.icon className="h-6 w-6 text-[#b979f0]" />
                        </div>
                        <div className={`flex items-center justify-center w-8 h-8 rounded-full bg-[#b979f0]/30 border border-[#b979f0]/30 ${index % 2 === 0 ? 'ml-4' : 'mr-4'}`}>
                          <span className="text-sm font-mono text-[#b979f0]">{step.step}</span>
                        </div>
                      </div>
      ...
      <section className="py-20 relative z-10">
        <div className="max-w-screen-xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-2">
              Built with <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#b979f0] to-[#4c30ad]">Reliable Technology</span>
            </h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              ...
              >
                ...
                <div className="flex items-center gap-4 mb-4 relative z-10">
                  <div className="w-12 h-12 rounded-full bg-blue-900/30 border border-blue-800/30 flex items-center justify-center">
                    <tech.icon className="h-6 w-6 text-[#b979f0]" />
                  </div>
      ...
      <section className="py-20 relative z-10">
        <div className="max-w-screen-xl mx-auto px-4">
          <div className="max-w-3xl mx-auto bg-[#0a0a0a] border border-[#b979f0]/30 rounded-xl p-12 shadow-md shadow-[#b979f0]/20 relative overflow-hidden">
            <div className="absolute inset-0 rounded-xl bg-gradient-to-r from-[#b979f0]/20 via-[#4c30ad]/10 to-[#b979f0]/20 opacity-50" />
            <div className="relative z-10 text-center">
              <h2 className="text-3xl md:text-4xl font-bold mb-6">
                Ready to <span className="text-transparent bg-clip-text bg-[#b979f0]">Start Trading</span>?
              </h2>
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <Link href="/markets" target="_blank">
                  <Button className="bg-gradient-to-r from-[#b979f0]/20 to-[#4c30ad] text-white hover:bg-gradient-to-r hover:from-[#4c30ad] hover:to-[#b979f0] px-8 py-6 text-lg font-medium rounded-xl border border-[#b979f0]/30 relative overflow-hidden group">
                    <div className="flex items-center gap-2 relative z-10">
                      Launch App
                      <ExternalLink size={20} />
                    </div>
